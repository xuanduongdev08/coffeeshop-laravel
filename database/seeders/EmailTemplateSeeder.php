...
<p><a href="{website_link}" style="background-color: #6f4e37; color: #ffffff !important; padding: 12px 24px; text-decoration: none; border-radius: 8px; display: inline-block; font-size: 15px; font-weight: 600; border: 1px solid #6f4e37; margin: 15px 0;">Ghé thăm cửa hàng</a></p>
<br>
...
<p><a href="{order_link}" style="background-color: #6f4e37; color: #ffffff !important; padding: 12px 24px; text-decoration: none; border-radius: 8px; display: inline-block; font-size: 15px; font-weight: 600; border: 1px solid #6f4e37; margin: 15px 0;">Xem chi tiết đơn hàng</a></p>
<br>
<p>Trân trọng,<br>Đội ngũ XDTHECOFFEEHOUSE</p>',
...
<p><a href="{order_link}" style="background-color: #6f4e37; color: #ffffff !important; padding: 12px 24px; text-decoration: none; border-radius: 8px; display: inline-block; font-size: 15px; font-weight: 600; border: 1px solid #6f4e37; margin: 15px 0;">Theo dõi đơn hàng của bạn</a></p>
<br>
<p>Trân trọng,<br>Đội ngũ XDTHECOFFEEHOUSE</p>',
