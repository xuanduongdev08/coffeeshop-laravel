    ...
    <div class="col-md-7">
        <div class="admin-card">
            ...
            <form method="POST" action="{{ route('admin.categories.update', $category) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="font-weight-bold">Slug (tự động)</label>
                    <input type="text" class="form-control" value="{{ $category->slug }}" disabled style="background:#f8f9fa;">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <img id="imagePreview"
                                src="{{ $category->image ? asset($category->image) : asset('images/menu-1.jpg') }}"
                ...
                <div class="d-flex gap-2" style="gap:10px;">
                    <button type="submit" class="btn btn-coffee">💾 Lưu thay đổi</button>
